			...
			<script src="<?php echo get_bloginfo( 'template_directory' );?>/assets/js/bootsnav.js"></script>
			<script src="<?php echo get_bloginfo( 'template_directory' );?>/assets/js/viewportchecker.js"></script>
			<script src="<?php echo get_bloginfo( 'template_directory' );?>/assets/plugins/bootstrap/js/bootstrap-select.min.js"></script>
			
			<!-- wysihtml5 editor js -->
			<script src="<?php echo get_bloginfo( 'template_directory' );?>/assets/plugins/bootstrap/js/wysihtml5-0.3.0.js"></script>
			<script src="<?php echo get_bloginfo( 'template_directory' );?>/assets/plugins/bootstrap/js/bootstrap-wysihtml5.js"></script>
			
			<!-- Owl carousel Js -->
			<script type="text/javascript" src="<?php echo get_bloginfo( 'template_directory' );?>/assets/plugins/owl-carousel/js/owl.carousel.min.js"></script>
